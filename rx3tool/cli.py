"""Command line for setting up and running RX3 on a supported ARM Linux board."""
import argparse
import os
import subprocess
import sys
...
STEPS = """\
Typical first installation on the Orange Pi (see README.md):
...
def selftest(verbose=False):
    ...
    for name in ('test-navigation.py', 'test-pad-mapping.py', 'test-ddj400-mapping.py', 'test-held-pads.py', 'test-shift-jog.py',
