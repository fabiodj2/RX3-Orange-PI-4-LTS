...
/* Orange Pi 4 LTS port: 1920x1080 landscape instead of 1200x1920 portrait.
 * frame-scale.h defines RX3_PANEL_W/H; kept in sync manually here since
 * this file doesn't include frame-scale.h (avoids a header-order
 * dependency) - if you change one, change the other. */
#ifndef RX3_PANEL_W
